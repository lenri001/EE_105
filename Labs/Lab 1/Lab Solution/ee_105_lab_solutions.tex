...
%\PassOptionsToPackage{USenglish,UKenglish}
%\usepackage[USenglish,UKenglish]{babel}
%\usepackage[nodayofweek,level]{datetime}
%\newcommand{\mydate}{\formatdate{09}{10}{2020}}
	...
	\section {Area under the Curve}
		...
		\subsection{Riemann Integral Approximation Equations}
			...
			\subsubsection{$Q_{2}$ and $Q$ vs $N$}
				\lstinputlisting[language=Matlab, caption = {\Large $Q_{2}$ Function}]{Code/q2_sum.m}
				\lstinputlisting[language=Matlab, caption = {\Large Plot $Q_{2}$ and $Q$ vs $N$}]{Code/q2_plot.m}
